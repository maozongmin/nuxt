...
export default {
    ...
    let res2 = await axios.get('http://api.yxstudio.cn/demo/getAdmin.php');
    ...
    let param = {
        ...
        let {data:{data:{list,total}}} = await axios.get('http://api.tgl.qq.com/open/static/content/list',{params:param});
        // let res = {}
